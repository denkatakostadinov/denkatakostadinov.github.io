...
mysqli_query($connection, "INSERT INTO Register (Name, Surname, Email, University, Course, Gender, Password) VALUES ('$name', '$surname', '$email', '$university', '$course', '$gender', '$password')");
